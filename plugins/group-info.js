...
try{
const msr = (await fetchJson('https://raw.githubusercontent.com/Arslan-MD/Arslan_MD/blob/main/assets/autoreply.json')).replyMsg

if (!isGroup) return reply(msr.only_gp)
if (!isAdmins) { if (!isDev) return reply(msr.you_adm),{quoted:mek }} 
if (!isBotAdmins) return reply(msr.give_adm)
const ppUrls = [
        'https://files.catbox.moe/lom1ep.png',
        'https://files.catbox.moe/lom1ep.png',
        'https://files.catbox.moe/lom1ep.png',
      ];
